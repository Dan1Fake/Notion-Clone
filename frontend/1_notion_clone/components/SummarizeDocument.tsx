...
type Language = "english" | "persian" | "spanish" | "portuguese" | "french" | "german" | "chinese" | "arabic" | "hindi" | "russian" | "japanese";

const languages: Language[] = ["english", "persian", "spanish", "portuguese", "french", "german", "chinese", "arabic", "hindi", "russian", "japanese"];

function SummarizeDocument({ doc }: { doc: Y.Doc }) {
